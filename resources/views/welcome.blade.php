<x-guest-layout>
    <div class="relative z-10 pt-48 pb-52 bg-cover bg-center" style="background-image: url(/img/6.jpg)">
        ...
        <div class="container relative z-20 text-white text-center text-2xl">
            <h2 class="font-bold text-5xl mb-8 langBN">{{__('Your guide to the primary Real Estate market in Ghana.')}}</h2>
            <p class="text-2xl mt-8 langBN">{{ __('The most convenient real estate search portal in Ghana, start searching now!') }}</p>
        </div>
    </div>
